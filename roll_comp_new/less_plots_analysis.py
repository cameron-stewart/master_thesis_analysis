...
for i in range(len(plots)):
    ...
    stressxx_sim = stressxx_sim-np.amin(stressxx_ana)
    stressxx_ana = stressxx_ana-np.amin(stressxx_ana)
   
    stressxx_sim = 0.8*stressxx_sim/np.amax(stressxx_ana)+0.1
    stressxx_ana = 0.8*stressxx_ana/np.amax(stressxx_ana)+0.1
